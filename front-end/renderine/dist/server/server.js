...
const postgraphile_1 = __webpack_require__(10);
const serverRender_1 = __webpack_require__(11);
...
if (!IS_PRODUCTION) {
    const webpackDevMiddleware = __webpack_require__(34);
    const webpack = __webpack_require__(6);
    const webpackConfig = __webpack_require__(35);
    const compiler = webpack(webpackConfig);
    server.use(webpackDevMiddleware(compiler, {
        publicPath: "/",
        noInfo: true
    }));
    server.use(__webpack_require__(41)(compiler));
}
server.get('*', (req, res) => {
    const context = {};
...
const apollo_client_1 = __webpack_require__(12);
const react_apollo_1 = __webpack_require__(1);
const apollo_link_http_1 = __webpack_require__(13);
const react_router_1 = __webpack_require__(14);
const apollo_cache_inmemory_1 = __webpack_require__(15);
const react_async_component_1 = __webpack_require__(2);
const react_async_bootstrapper_1 = __webpack_require__(16);
...
const react_router_dom_1 = __webpack_require__(3);
const header_1 = __webpack_require__(19);
const home_1 = __webpack_require__(20);
const asyncAuthors_1 = __webpack_require__(21);
const allArticles_1 = __webpack_require__(23);
const asyncFatComponent_1 = __webpack_require__(24);
...
exports.default = react_async_component_1.asyncComponent({
    resolve: () => new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 22))
});
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(0);
const graphql_tag_1 = __webpack_require__(4);
const react_apollo_1 = __webpack_require__(1);
...
const react_async_component_1 = __webpack_require__(2);
exports.default = react_async_component_1.asyncComponent({
    resolve: () => new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 25))
});
...
const React = __webpack_require__(0);
const react_1 = __webpack_require__(0);
const react_render_image_1 = __webpack_require__(26);
...
const counter_1 = __webpack_require__(28);
...
/* WEBPACK VAR INJECTION */(function(__dirname) {const path = __webpack_require__(36);
const webpack = __webpack_require__(6);

const UglifyJSPlugin = __webpack_require__(37);
const ExtractTextPlugin = __webpack_require__(38);
const StatsWriterPlugin = __webpack_require__(39).StatsWriterPlugin;
const BundleAnalyzerPlugin = __webpack_require__(40).BundleAnalyzerPlugin;
