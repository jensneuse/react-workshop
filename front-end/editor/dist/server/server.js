...
const postgraphile_1 = __webpack_require__(9);
const serverRender_1 = __webpack_require__(10);
...
if (!IS_PRODUCTION) {
    ...
    server.use(__webpack_require__(32)(compiler));
}
server.get('*', (req, res) => {
    const context = {};
...
const apollo_client_1 = __webpack_require__(20);
const react_apollo_1 = __webpack_require__(2);
const apollo_link_http_1 = __webpack_require__(21);
const react_router_1 = __webpack_require__(22);
const apollo_cache_inmemory_1 = __webpack_require__(23);
const react_async_component_1 = __webpack_require__(1); // 👈
const react_async_bootstrapper_1 = __webpack_require__(24);
...
const header_1 = __webpack_require__(12);
const home_1 = __webpack_require__(13);
const asyncAuthors_1 = __webpack_require__(14);
const allArticles_1 = __webpack_require__(16);
const asyncFatComponent_1 = __webpack_require__(17);
...
exports.default = react_async_component_1.asyncComponent({
    resolve: () => new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 15))
});
...
const react_async_component_1 = __webpack_require__(1);
exports.default = react_async_component_1.asyncComponent({
    resolve: () => new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 18))
});
...
const React = __webpack_require__(0);
const react_1 = __webpack_require__(0);
const react_render_image_1 = __webpack_require__(19);
...
/* WEBPACK VAR INJECTION */(function(__dirname) {const path = __webpack_require__(27);
const webpack = __webpack_require__(5);

const UglifyJSPlugin = __webpack_require__(28);
const ExtractTextPlugin = __webpack_require__(29);
const StatsWriterPlugin = __webpack_require__(30).StatsWriterPlugin;
const BundleAnalyzerPlugin = __webpack_require__(31).BundleAnalyzerPlugin;
